...
export class HUDScene extends BaseScene {
  ...
  createControlsPanel() {
    this.valueLabel = this.rexUI.add
      .label({
        ...
        originY: 1,
        width: this.utils._px(125),
        height: this.utils._px(53),
        background: this.add
          .image(0, 0, "btnSmallBg")
    ...
    const button = this.rexUI.add
      .label({
        ...
        background: this.rexUI.add
          .roundRectangle(0, 0, 2, 2, this.utils._px(10), 0x1198c9)
          .setStrokeStyle(this.utils._px(4), 0x00bbff),
        icon: this.add
  ...
  createTimePanel() {
    ...
    timePanel.addBackground(
      this.rexUI.add.roundRectangle(0, 0, 2, 2, this.utils._px(10), 0x1198c9),
    );
    timePanel.add(
      this.add
  ...
  createComboPanel() {
    const comboPanel = this.rexUI.add
      ...
      .addBackground(
        this.rexUI.add.roundRectangle(0, 0, 0, 0, this.utils._px(10), 0x1198c9),
      );
